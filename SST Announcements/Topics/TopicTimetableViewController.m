//
//  TopicTimetableViewController.m
//  SST Announcements
//
...
#import "TopicTimetableViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicTimetableViewController () {
    NSXMLParser *parser;
...
@implementation TopicTimetableViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/TimeTable?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"TimetableToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"TimetableToDetail"])
    {
