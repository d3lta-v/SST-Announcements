...
#import "TopicReopenViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicReopenViewController () {
    NSXMLParser *parser;
...
@implementation TopicReopenViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/School%20Reopen?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"ReopenToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"ReopenToDetail"])
    {
