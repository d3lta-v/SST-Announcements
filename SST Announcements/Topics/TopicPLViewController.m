//
//  TopicPLViewController.m
//  SST Announcements
//
//  Created by Pan Ziyue on 12/7/13.
//  Copyright (c) 2013 Pan Ziyue. All rights reserved.
//

#import "TopicPLViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicPLViewController () {
    NSXMLParser *parser;
...
@implementation TopicPLViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/Principal's%20Letter?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"LetterToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"LetterToDetail"])
    {
