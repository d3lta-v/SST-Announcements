//
//  TopicLeadershipViewController.m
//  SST Announcements
//
//  Created by Pan Ziyue on 14/7/13.
//  Copyright (c) 2013 Pan Ziyue. All rights reserved.
//

#import "TopicLeadershipViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicLeadershipViewController () {
    NSXMLParser *parser;
...
@implementation TopicLeadershipViewController
...
#pragma mark Change title
    label.text = @"Category: Leadership";
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/Student%20Leadership?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"LeadershipToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"LeadershipToDetail"])
    {
