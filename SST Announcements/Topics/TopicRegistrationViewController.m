//
//  TopicRegistrationViewController.m
//  SST Announcements
//
...
#import "TopicRegistrationViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicRegistrationViewController () {
    NSXMLParser *parser;
...
@implementation TopicRegistrationViewController
...
#pragma mark Change URL
            NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/S1%20Registration?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"RegistrationToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"RegistrationToDetail"])
    {
