//
//  TopicAssessmentsViewController.m
//  SST Announcements
//
...
#import "TopicAssessmentsViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicAssessmentsViewController () {
    NSXMLParser *parser;
...
@implementation TopicAssessmentsViewController
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    label.text = @"Category: Assessments";
    ...
    dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
        ...
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/assessment?alt=rss"];
...
{
    [self performSegueWithIdentifier:@"AssessmentsToDetail" sender:self]; //Perform the segue
    [tableView deselectRowAtIndexPath:indexPath animated:YES]; //Deselect the row automatically
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"AssessmentsToDetail"])
    {
