...
#import "TopicSupportViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicSupportViewController () {
    NSXMLParser *parser;
...
@implementation TopicSupportViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/support?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"SupportToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"SupportToDetail"])
    {
