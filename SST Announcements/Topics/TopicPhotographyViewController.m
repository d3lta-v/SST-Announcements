//
//  TopicPhotographyViewController.m
//  SST Announcements
//
...
#import "TopicPhotographyViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicPhotographyViewController () {
    NSXMLParser *parser;
...
@implementation TopicPhotographyViewController
...
#pragma mark Change title
    label.text = @"Category: Photography";
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"PhotographyToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"PhotographyToDetail"])
    {
