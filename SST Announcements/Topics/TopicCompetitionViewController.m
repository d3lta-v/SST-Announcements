...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    label.text = @"Category: Competition";
...
{
    [self performSegueWithIdentifier:@"CompetitionToDetail" sender:self]; //Perform the segue
    [tableView deselectRowAtIndexPath:indexPath animated:YES]; //Deselect the row automatically
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"CompetitionToDetail"])
    {
