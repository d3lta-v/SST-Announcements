//
//  TopicCompetitionViewController.m
//  SST Announcements
//
...
#import "TopicCompetitionViewController.h"
#import "RSSEntry.h"
...
@interface TopicCompetitionViewController ()

@end

@implementation TopicCompetitionViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"Topic: Competition";
    self.allEntries = [NSMutableArray array];
    self.queue = [[NSOperationQueue alloc] init];
    self.feeds = [NSArray arrayWithObjects:@"http://sst-students2013.blogspot.com/feeds/posts/default/-/Competition",nil];
    [self refresh];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"CompetitionToDetail" sender:nil];
}
