...
#import "TopicITViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicITViewController () {
    NSXMLParser *parser;
...
@implementation TopicITViewController
...
- (void)viewDidLoad {
    ...
    if ([self.navigationController.viewControllers count]) {
        ...
        dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
            ...
            NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/IT?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"ITToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"ITToDetail"])
    {
