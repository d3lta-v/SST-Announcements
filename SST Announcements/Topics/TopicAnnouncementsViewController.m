...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    label.text = @"Category: Announcements";
    ...
    dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
        ...
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/Announcement?alt=rss"];
...
{
    [self performSegueWithIdentifier:@"AnnouncementsToDetail" sender:self]; //Perform the segue
