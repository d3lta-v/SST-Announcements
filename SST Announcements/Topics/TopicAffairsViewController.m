...
#import "TopicAffairsViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicAffairsViewController () {
    NSXMLParser *parser;
...
@implementation TopicAffairsViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/Student%20Affairs?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"AffairsToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"AffairsToDetail"])
    {
