...
#import "TopicLearningViewController.h"
#import "WebViewController.h"
#import "SVProgressHUD.h"
#import "RefreshControl.h"

@interface TopicLearningViewController () {
    NSXMLParser *parser;
...
@implementation TopicLearningViewController
...
#pragma mark Change URL
        NSURL *url = [NSURL URLWithString:@"http://sst-students2013.blogspot.sg/feeds/posts/default/-/service%20learning?alt=rss"];
...
#pragma mark Change Indent
    [self performSegueWithIdentifier:@"LearningToDetail" sender:self]; //Perform the segue
...
#pragma mark Change Ident
    if ([[segue identifier] isEqualToString:@"LearningToDetail"])
    {
